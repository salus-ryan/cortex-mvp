...
Open the installable mobile PWA:
...
curl -X POST "$BASE/learning/package" -H 'content-type: application/json' -d '{}'
...
├── auth.py              # Token/capability auth primitive
